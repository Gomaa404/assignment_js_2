            ...
            return (
              (t[i] = (function (t, e, i) {
                var n = ye(t),
                  ...
                  a = o[1];
                return (
                  (r = r || 0), (a = (a || 0) * s), [Qt, Kt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                );
              })(i, e.rects, o)),
              t
            );
  ...
  function fi(t, e, i) {
    ...
    return (
      (o || (!o && !i)) &&
        (("body" !== pe(e) || Je(a)) &&
          (c =
            (n = e) !== me(n) && _e(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : Ue(n)),
  ...
  class Ki extends W {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu =
          z.next(this._element, Mi)[0] || z.prev(this._element, Mi)[0] || z.findOne(Mi, this._parent)),
    ...
    static dataApiKeydownHandler(t) {
      ...
      const s = this.matches(Pi)
          ? this
          : z.prev(this, Pi)[0] || z.next(this, Pi)[0] || z.findOne(Pi, t.delegateTarget.parentNode),
    ...
    _setListeners() {
      ...
      for (const e of t)
        if ("click" === e)
          ...
          const t =
              e === as ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
  ...
  class Ls extends W {
    ...
    _activateParents(t) {
      if (t.classList.contains("dropdown-item"))
        ...
        for (const e of z.parents(t, ".nav, .list-group")) for (const t of z.prev(e, Os)) t.classList.add(Es);
    }
    _clearActiveClass(t) {
